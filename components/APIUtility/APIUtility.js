...
let APIConfigSingleTon = (function () {
  ...
  var config = {
    ...
    authHeaders: {
      ACCESS_TOKEN:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoiZ29kIiwicHJpbWFyeVJvbGUiOiJ0ZWFjaGVyIiwic2Vjb25kYXJ5Um9sZSI6IiIsInRpbWVzdGFtcCI6MTYxODQyNzc5MDM4MiwiaWQiOiI2MDVlMzZhNTlkODA4YTBmNTFjZTdmNGEiLCJzY2hvb2xJRCI6IjYwNWRmMjY4MThjNmNkMGE4Zjg2ODQyMCIsImlhdCI6MTYxODQyNzc5MH0.6nXD1rMJDRoh7XtEUGzN_qNCY4yieluzs1ZfyCQFI8w',
    },

    /* Endpoints */
    endpoints: {
      getSubject: 'http://localhost:9000/subject',
      getAssessment: 'http://localhost:9000/assessment',
      getAttendance: 'http://localhost:9001/attendance',
      getTask: 'http://localhost:9002/task',
      getResult: 'http://localhost:9003/result',
      getTimeTable: 'http://localhost:9001/timeTable',
    },
  ...
  let insertEndpoints = (endpoints) => {
    try {
      /* Sanity Check */
      if (endpoints === undefined || typeof endpoints !== 'object') {
        throw 'Invaild Parameter';
      }
      ...
      for (let urlName in endpoints) {
        ...
        if (typeof endpoints[urlName] !== 'string') {
